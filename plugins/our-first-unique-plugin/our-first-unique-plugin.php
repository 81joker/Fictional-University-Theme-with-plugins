...
class WordCountAndTimePlugin
{
  ...
  {
    $html = '<h3>' . esc_html(get_option('wcp_headline', 'Post Statistics nehad demo headLinde')) . '</h3><p>';
    ...
    if (get_option('wcp_readtime', '1')) {
      $html .= __('This post will take about','wcpdomain') . ' ' . round($wordCount / 225) . ' ' .__(' minute(s) to read', 'wcpdomain');
    }
